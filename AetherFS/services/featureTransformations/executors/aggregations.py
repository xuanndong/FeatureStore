...
class AggregationBased:
    ...
    @contextmanager
    def execute(self, dataset: ds.Dataset | pa.Table, entity_keys: list[str], time_column: str, features: list[dict], windows: list[str], table_name: VirtualTable = VirtualTable.SOURCE_DATA):
        """
